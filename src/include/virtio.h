...
typedef struct PciDevice {
    ...
    int irq;
    volatile uint64_t dev_config;
} PciDevice;

extern List *g_virtio_devices; /* Global list for VirtIO devices. */
...
typedef struct VirtioDevice {
    ...
    void *priv; //No idea what this is tbh
    struct Map *jobs;//I just made a list_new() here. Not sure what else needs to happen with this. 
    Mutex lock;
...
#define VIRTIO_QUEUE_ENABLE 0x1
